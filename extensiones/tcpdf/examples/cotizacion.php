...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:200px; border: 1px solid #fff;">

				<div style="font-size:10px; text-align:center; line-height:15px;">
					
					Acta de entrega activos Tecnologia
				</div>
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:260px; text-align:center">Empleado</td>
			<td style="border: 1px solid #666; background-color:white; width:80px; text-align:center">Activo</td>
