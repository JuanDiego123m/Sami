  ...
  if(isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok"){
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
         ...
         $_GET["ruta"] == "clientes" ||
         $_GET["ruta"] == "modulos" ||
         $_GET["ruta"] == "editar-modulo" ||
         $_GET["ruta"] == "numeracion" ||
         $_GET["ruta"] == "editar-numeracion" ||
         $_GET["ruta"] == "ventas" ||
...
<script src="vistas/js/numeraciones.js"></script>
<script src="vistas/js/ventas.js"></script>
<script src="vistas/js/inventario.js"></script>
<script src="vistas/js/reportes.js"></script>
<script src="vistas/js/desarrollos.js"></script>
